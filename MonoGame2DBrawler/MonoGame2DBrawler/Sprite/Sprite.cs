...
namespace MonoGame2DBrawler.Sprite
{
    ...
    public class Sprite : GameObject, ICollidable, IMDrawable
    {
        ...
        public Sprite(string name, Vector2 position, PlayerIndex playerIndex, Texture2D texture = null, KeyboardInput input = null, GamePadInput gamePadInput = null)
        {
            _name = name;
            _position = position;
            ...
            _boundingBoxLeftLine = new Rectangle();
            _boundingBoxTopLine = new Rectangle();
            _boundingBoxRightLine = new Rectangle();
            _boundingBoxBottomLine = new Rectangle();

            _boundingBoxTexture = new
